...
function bindEvents(){
  ...
  $('#receiptProfile').addEventListener('change',e=>fillCategories(e.target.value)); $('#receiptRecordType').addEventListener('change',toggleScannedRecordFields); $('#receiptFile').addEventListener('change',handleImage);
